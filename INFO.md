...
- M_Dans_Bat_001 à M_Dans_Bat_XXX sont game logic placé dans des batiments les M_Dans_Bat_XXX déterminent des lieux précis de missions ( respecter absolument le x,y,z + 0.2)
- Heliport_001 à Heliport_XXX sont des heliport invisibles. pour l'hélicoptère allié
- player_01 à player_XX sont les unités jouables (Royal Army Corps of Sahrani - independant)
...
- Des femmes sont présentes dans l'éditeur grace à un mod les noms des variables pour les femmes sont : (mod : MAX WOMAN)
